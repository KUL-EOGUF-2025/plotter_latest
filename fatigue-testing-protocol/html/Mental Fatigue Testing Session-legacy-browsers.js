...
function F_ISARoutineBegin(snapshot) {
  return function () {
    ...
    F_ISAComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function instrBRUMSpreRoutineBegin(snapshot) {
  return function () {
    ...
    instrBRUMSpreComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function BRUMS_1RoutineBegin(snapshot) {
  return function () {
    ...
    BRUMS_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function BRUMS_2RoutineBegin(snapshot) {
  return function () {
    ...
    BRUMS_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function BRUMS_3RoutineBegin(snapshot) {
  return function () {
    ...
    BRUMS_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function instrAXCPTbreak1RoutineBegin(snapshot) {
  return function () {
    ...
    instrAXCPTbreak1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function AXCPTtrialsLoop1LoopBegin(AXCPTtrialsLoop1LoopScheduler) {
  ...
  AXCPTtrialsLoop1.forEach(function() {
...
function NBackTargetLoop1LoopBegin(NBackTargetLoop1LoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  NBackTargetLoop1.forEach(function() {
...
function NBackTrialsLoop1LoopBegin(NBackTrialsLoop1LoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  NBackTrialsLoop1.forEach(function() {
...
function mentRotTrialsLoop1LoopBegin(mentRotTrialsLoop1LoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  mentRotTrialsLoop1.forEach(function() {
...
function NBackTargetLOOP2LoopBegin(NBackTargetLOOP2LoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  NBackTargetLOOP2.forEach(function() {
...
function NBackTrialsLoop2LoopBegin(NBackTrialsLoop2LoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  NBackTrialsLoop2.forEach(function() {
...
function AXCPTtrialsLoop2LoopBegin(AXCPTtrialsLoop2LoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  AXCPTtrialsLoop2.forEach(function() {
...
function mentRotTrialsLoop2LoopBegin(mentRotTrialsLoop2LoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  mentRotTrialsLoop2.forEach(function() {
...
function NBackTargetLoop3LoopBegin(NBackTargetLoop3LoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  NBackTargetLoop3.forEach(function() {
...
function NBackTrialsLoop3LoopBegin(NBackTrialsLoop3LoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  NBackTrialsLoop3.forEach(function() {
...
function mentRotTrialsLoop3LoopBegin(mentRotTrialsLoop3LoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  mentRotTrialsLoop3.forEach(function() {
...
function AXCPTtrialsLoop3LoopBegin(AXCPTtrialsLoop3LoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  AXCPTtrialsLoop3.forEach(function() {
...
function instrNBACKbreak2RoutineBegin(snapshot) {
  return function () {
    ...
    instrNBACKbreak2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function instrSEARCHbreak3RoutineBegin(snapshot) {
  return function () {
    ...
    instrSEARCHbreak3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function instrMENTROTbreak4RoutineBegin(snapshot) {
  return function () {
    ...
    instrMENTROTbreak4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function instrNBACKbreak5RoutineBegin(snapshot) {
  return function () {
    ...
    instrNBACKbreak5Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function instrAXCPTbreak6RoutineBegin(snapshot) {
  return function () {
    ...
    instrAXCPTbreak6Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function instrSEARCHbreak7RoutineBegin(snapshot) {
  return function () {
    ...
    instrSEARCHbreak7Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function instrMENTROTbreak8RoutineBegin(snapshot) {
  return function () {
    ...
    instrMENTROTbreak8Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function instrNBACKbreak9RoutineBegin(snapshot) {
  return function () {
    ...
    instrNBACKbreak9Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function instrSEARCHbreak10RoutineBegin(snapshot) {
  return function () {
    ...
    instrSEARCHbreak10Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function instrMENTROTbreak11RoutineBegin(snapshot) {
  return function () {
    ...
    instrMENTROTbreak11Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function instrAXCPTbreak12RoutineBegin(snapshot) {
  return function () {
    ...
    instrAXCPTbreak12Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function instrBRUMSpostRoutineBegin(snapshot) {
  return function () {
    ...
    instrBRUMSpostComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
