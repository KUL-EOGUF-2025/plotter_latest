...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\sofia\\Desktop\\YEAR5\\Thesis\\Code\\Inducing Mental Fatigue\\Data Collection\\mental-fatigue-battery-testing-session\\Mental Fatigue Testing Session_lastrun.py',
...
slider = visual.Slider(win=win, name='slider',
    ...
    labels=(very low - alert, low, medium - relaxed wakeful, very high - fatigued), ticks=(1, 2, 3, 4, 5),
...
slider.reset()
# keep track of which components have finished
F_ISAComponents = [mouse, slider, text_4, mouse_visibility]
...
while continueRoutine:
    ...
    if mouse_visibility.status == STARTED:  # only update if drawing
        mouse_visibility.setPos((mouse.get_Pos()[0], mouse.get_Pos()[1]), log=False)
